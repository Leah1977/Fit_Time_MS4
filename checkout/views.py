...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        if order_form.is_valid():
            ...
            messages.error(request, "There was an error when submitting your form. \
            Please check you have the correct information.")
    else:
        basket = request.session.get('basket', {})
        if not basket:
        ...
        # Attempt to prefill form is info is avaialble from the profile
